export const PLAYERS = [
  {
    ...
    assessmentHistory: [
      { id: "assess_003", date: "24 Aug 2026", technical: 4, tactical: 4, physical: 5,
        mentalCompetition: 4, gameUnderstanding: 4, coachComment: "..." },
      { id: "assess_002", date: "10 Aug 2026", technical: 4, tactical: 4, physical: 5,
        mentalCompetition: 4, gameUnderstanding: 4, coachComment: "..."  },
      { id: "assess_001", date: "01 Aug 2026", technical: 4, tactical: 4, physical: 5,
        mentalCompetition: 4, gameUnderstanding: 4, coachComment: "..."  },
    ],
    recentClasses: [
    ...
    notes: [
      { id: "note_001", date: "24 Aug 2026", coach: "Roberto", text: "Ready to compete at the next tournament. Keep monitoring shoulder load." },
      { id: "note_002", date: "15 Aug 2026", coach: "Roberto", text: "Discussed match schedule with parents. Focus block on return games." },
    ],
  },
  {
    id: "player_002",
    ...
    assessmentHistory: [
      { id: "assess_004", date: "22 Aug 2026", technical: 3, tactical: 4, physical: 4,
        mentalCompetition: 3, gameUnderstanding: 4, coachComment: "..." },
    ],
    recentClasses: [
      { id: "class_006", className: "Technical", coach: "Kiril", duration: 60, date: "24 Aug 2026" },
    ],
    notes: [
      { id: "note_003", date: "22 Aug 2026", coach: "Kiril", text: "Good tactical understanding but needs more consistency in matches." },
    ],
  },
  {
    id: "player_003",
    ...
    assessmentHistory: [
      { id: "assess_005", date: "13 Aug 2026", technical: 3, tactical: 3, physical: 4,
        mentalCompetition: 3, gameUnderstanding: 3, coachComment: "Strong at net. Needs patience in long rallies." },
    ],
    recentClasses: [
      { id: "class_007", className: "Match Play", coach: "Kiril", duration: 90, date: "12 Aug 2026" },
    ],
    notes: [
      { id: "note_004", date: "13 Aug 2026", coach: "Kiril", text: "Strong at net. Needs patience in long rallies." },
    ],
  },
  {
    id: "player_004",
    ...
    assessmentHistory: [
      { id: "assess_006", date: "06 Aug 2026", technical: 3, tactical: 2, physical: 3,
        mentalCompetition: 3, gameUnderstanding: 2, coachComment: "Improving steadily. Focus on footwork before power." },
    ],
    recentClasses: [
      { id: "class_008", className: "Technical", coach: "Roberto", duration: 60, date: "05 Aug 2026" },
    ],
    notes: [
      { id: "note_005", date: "06 Aug 2026", coach: "Roberto", text: "Improving steadily. Focus on footwork before power." },
    ],
  },
  {
    id: "player_005",
    ...
    assessmentHistory: [
      { id: "assess_007", date: "29 Jul 2026", technical: 2, tactical: 2, physical: 3,
        mentalCompetition: 3, gameUnderstanding: 2, coachComment: "Fast learner with good attitude." },
    ],
    recentClasses: [
      { id: "class_009", className: "Group Class", coach: "Lau", duration: 90, date: "28 Jul 2026" },
    ],
    notes: [
      { id: "note_006", date: "29 Jul 2026", coach: "Lau", text: "Fast learner with good attitude." },
    ],
  },
  {
    id: "player_006",
    ...
    assessmentHistory: [
      { id: "assess_008", date: "06 Aug 2026", technical: 3, tactical: 2, physical: 3,
        mentalCompetition: 3, gameUnderstanding: 2, coachComment: "Improving steadily. Focus on footwork before power." },
    ],
    recentClasses: [
    ...
    notes: [
      { id: "note_007", date: "21 Jul 2026", coach: "Kiril", text: "Just started. Very motivated." },
    ],
  },
];
...
export const EMPTY_PLAYER_EXTRAS = {
  ...
  assessmentHistory: [
      { id: "", date: "", technical: 0, tactical: 0, physical: 0,
        mentalCompetition: 0, gameUnderstanding: 0, coachComment: "" }],
  recentClasses: [],
  notes: [],
};